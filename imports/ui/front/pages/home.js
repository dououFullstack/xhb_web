  ...
  render() {
    return (
      <div>
        ...
        <section className="color2 boxH">
           <div className="ctaBox ctaBoxFullwidth">
              <div className="container">
                 <div className="row">
                    <div className="col-md-9">
                       <h1>
                          本次大赛由工业和信息化部电子信息司主办，旨在推动智能硬件核心技术的转化与智能硬件应用的升级，提高相关专业年轻人在智能硬件技术应用创新设计能力、促进智能硬件行业技术的应用升级.
                       </h1>
                    </div>
      ...
      <a href="/about"> >> 详细信息 </a>
        ...
        <section className="slice color1" id="news">
           <div className="container">
              <div className="row">
                 <div className="col-xs-12">
                    <h1>赛事资讯</h1>
